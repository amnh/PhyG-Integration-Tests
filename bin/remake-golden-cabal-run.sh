...
for SUBDIRECTORY in "${SUB_DIRS[@]}"; do
	printf "${STYLE_BLUE}Test case:\t${STYLE_BLINK}${STYLE_BOLD}%s${STYLE_NORMAL}\n" "${SUBDIRECTORY}"
        ...
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}-cs.gv"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}-cs.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-cc.gv"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-ci.gv"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-cc.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-ci.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-Adams.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-cun.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-eun.tre"
        blessing_of_Midas "${SUBDIRECTORY}/${SUBDIRECTORY}_rec-maj.tre"
